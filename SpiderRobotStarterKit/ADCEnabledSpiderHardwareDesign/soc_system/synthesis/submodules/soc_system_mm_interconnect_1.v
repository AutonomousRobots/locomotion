...
module soc_system_mm_interconnect_1 (
	...
	wire          master_secure_master_agent_cp_valid;                                     // master_secure_master_agent:cp_valid -> router:sink_valid
	wire  [117:0] master_secure_master_agent_cp_data;                                      // master_secure_master_agent:cp_data -> router:sink_data
	wire          master_secure_master_agent_cp_ready;                                     // router:sink_ready -> master_secure_master_agent:cp_ready
	wire          master_secure_master_agent_cp_startofpacket;                             // master_secure_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          master_secure_master_agent_cp_endofpacket;                               // master_secure_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          router_src_valid;                                                        // router:src_valid -> master_secure_master_limiter:cmd_sink_valid
	wire  [117:0] router_src_data;                                                         // router:src_data -> master_secure_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                        // master_secure_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                      // router:src_channel -> master_secure_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                // router:src_startofpacket -> master_secure_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                  // router:src_endofpacket -> master_secure_master_limiter:cmd_sink_endofpacket
	wire  [117:0] master_secure_master_limiter_cmd_src_data;                               // master_secure_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          master_secure_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> master_secure_master_limiter:cmd_src_ready
	wire    [1:0] master_secure_master_limiter_cmd_src_channel;                            // master_secure_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          master_secure_master_limiter_cmd_src_startofpacket;                      // master_secure_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          master_secure_master_limiter_cmd_src_endofpacket;                        // master_secure_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                       // rsp_mux:src_valid -> master_secure_master_limiter:rsp_sink_valid
	wire  [117:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> master_secure_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                       // master_secure_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> master_secure_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                               // rsp_mux:src_startofpacket -> master_secure_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                                 // rsp_mux:src_endofpacket -> master_secure_master_limiter:rsp_sink_endofpacket
	...
	wire  [117:0] master_secure_master_limiter_rsp_src_data;                               // master_secure_master_limiter:rsp_src_data -> master_secure_master_agent:rp_data
	...
	wire    [1:0] master_secure_master_limiter_cmd_valid_data;                             // master_secure_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_valid          (master_secure_master_limiter_cmd_valid_data)                        // cmd_valid.data
	);

	soc_system_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                                    //        clk.clk
		.reset              (master_secure_master_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (master_secure_master_limiter_cmd_src_ready),                        //       sink.ready
		.sink_channel       (master_secure_master_limiter_cmd_src_channel),                      //           .channel
		.sink_data          (master_secure_master_limiter_cmd_src_data),                         //           .data
		.sink_startofpacket (master_secure_master_limiter_cmd_src_startofpacket),                //           .startofpacket
		.sink_endofpacket   (master_secure_master_limiter_cmd_src_endofpacket),                  //           .endofpacket
		.sink_valid         (master_secure_master_limiter_cmd_valid_data),                       // sink_valid.data
