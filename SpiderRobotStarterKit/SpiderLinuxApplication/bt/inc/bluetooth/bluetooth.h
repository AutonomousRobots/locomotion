...
//richard#define BDADDR_ANY   (&(bdaddr_t) {{0, 0, 0, 0, 0, 0}})
//richard#define BDADDR_ALL   (&(bdaddr_t) {{0xff, 0xff, 0xff, 0xff, 0xff, 0xff}})
//richard#define BDADDR_LOCAL (&(bdaddr_t) {{0, 0, 0, 0xff, 0xff, 0xff}})
